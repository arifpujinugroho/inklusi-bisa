...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="{{url('assets/img/fav-icon.png')}}" type="image/x-icon" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>INKLUSI BISA</title>
        ...
        <!-- Rev slider css -->
        <link href="{{url('assets/vendors/revolution/css/settings.css')}}" rel="stylesheet">
        <link href="{{url('assets/vendors/revolution/css/layers.css')}}" rel="stylesheet">
        <link href="{{url('assets/vendors/revolution/css/navigation.css')}}" rel="stylesheet">
        
        <!-- Extra plugin css -->
        <link href="{{url('assets/vendors/owl-carousel/owl.carousel.min.css')}}" rel="stylesheet">
    ...
    <body runat="server" id="Body" style="zoom: 70%">
        
        <!--================Header Menu Area =================-->
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#"><img width="50%" src="{{url('assets/img/extra-small.png')}}" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarKarakteristik" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Karakteristik ABK
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarKarakteristik">
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunanetra</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunarungu</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunagrahita</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunadaksa</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunalaras</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Anak Tunaganda</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Kecerdasan Luar Biasa</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">ADHD</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Autis</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Slow Learner</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#">Prinsip Pembelajaran</a></li>
                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Media
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li class="nav-item"><a class="nav-link" href="#">Universal</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Video</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Voto</a></li>
                            </ul>
                        </li>
                ...
                <ul>
                    <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="slider_text_box">
                            ...
                            data-textAlign="['left','left','left','left','left','center']"><small>INKLUSI BISA <br />Media Pengetahuan ABK</small> </div>
                            ...
                            data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:0px;s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                            data-textAlign="['left','left','left','left','left','center']">
                                <img src="{{url('assets/img/home-slider/slider-m-1.png')}}" alt="">
                            </div>
                        </div>
                    </li>
            ...
            <div class="footer_copyright">
                <div class="container">
                    <div class="float-sm-left">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || INKLUSI BISA 
        ...
        <!-- Rev slider js -->
        <script src="{{url('assets/vendors/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.actions.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.navigation.min.js')}}"></script>
        <script src="{{url('assets/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
        <!-- Extra plugin css -->
        <script src="{{url('assets/vendors/counterup/jquery.waypoints.min.js')}}"></script>
        <script src="{{url('assets/vendors/counterup/jquery.counterup.min.js')}}"></script> 
        <script src="{{url('assets/vendors/counterup/apear.js')}}"></script>
        <script src="{{url('assets/vendors/counterup/countto.js')}}"></script>
        <script src="{{url('assets/vendors/owl-carousel/owl.carousel.min.js')}}"></script>
        <script src="{{url('assets/vendors/magnify-popup/jquery.magnific-popup.min.js')}}"></script>
